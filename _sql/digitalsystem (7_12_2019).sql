...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 07, 2019 at 10:24 AM
...
CREATE TABLE IF NOT EXISTS `sales` (
  ...
  `date` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_box` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `loose_box` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ovarall_box` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `netvalue` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `previous_balance` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ovarall_balance` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
